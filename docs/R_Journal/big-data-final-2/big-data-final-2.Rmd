...
[Wines by Taste](https://www.primermagazine.com/2011/learn/an-easy-explanation-of-wine-types)

https://winefolly.com/tutorial/weird-wine-flavors-and-the-science-behind-them/

VA intensifies the taste of
the other acids and tannins (https://www.awri.com.au/wp-content/uploads/2018/03/s1982.pdf)
...
```{r plot_rf2_rw, fig.width=8, fig.height=5, fig.align="center", message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="SVM Prediction"}
library(ggplot2)
