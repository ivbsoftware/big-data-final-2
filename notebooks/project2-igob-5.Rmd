...
```{r message=FALSE, warning=FALSE}
library(caret)
news_data.rows<- createDataPartition(y= news_data_full$shares_bins_norm, p=0.99, list = FALSE)
...
```{r plot_nn, fig.height=10, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Graphical representation of the NN model with the weights on each connection:"}
plot(nn)
```
